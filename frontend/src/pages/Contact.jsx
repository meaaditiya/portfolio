...
const copyTicketId = () => {
 ...
 let otpEndpoint = 'https://connectwithaaditiyamg2.onrender.com/api/contact/send-otp';
    if (isProject) {
      otpEndpoint = 'https://connectwithaaditiyamg2.onrender.com/api/project/send-otp';
    } else if (isAudio) {
      otpEndpoint = 'https://connectwithaaditiyamg2.onrender.com/api/audio-contact/send-otp';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isAudio) {
        ...
        const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/audio-contact', formDataToSend, {
          headers: {
        ...
        const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/project/submit', formDataToSend, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
        ...
        const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/contact', formData);
...
const handleQuerySubmit = async (e) => {
  ...
  try {
    const response = await axios.post('https://connectwithaaditiyamg2.onrender.com/api/queries/create', queryFormData);
...
if (!/^QRY\d{12}$/.test(normalized)) {
  ...
  try {
    const response = await axios.get(`https://connectwithaaditiyamg2.onrender.com/api/queries/check/${ticketId}`);
